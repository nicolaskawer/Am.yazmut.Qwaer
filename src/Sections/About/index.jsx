      ...
      <div className="container">
        ...
        <div className="about__content">
          <SectionHeader
            ...
            description="בא.מ. יזמות ובנייה כללית, אנו מחויבים לספק פרויקטים מעולים עם דגש על איכות, חדשנות ושביעות רצון הלקוח. עם למעלה מ-25 שנות ניסיון, אנו מביאים מומחיות, דיוק ויצירתיות לכל פרויקט, בין אם מדובר בבית פרטי, מגדל מגורים, או פרויקט מסחרי."
          />
